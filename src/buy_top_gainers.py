"""
Buy Top Gainers - Identifies and buys top gaining stocks
...
Usage:
    ...
    python buy_top_gainers.py --execute           # Buy top 5 gainers
...
def main():
    parser = argparse.ArgumentParser(description='Buy top gaining stocks')
    ...
    print()
    print("-" * 80)
    print(f"{'Symbol':<15} {'Qty':>6} {'Price':>12} {'Amount':>15} {'Gain%':>10}")
    print("-" * 80)
